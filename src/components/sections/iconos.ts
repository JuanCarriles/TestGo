// Iconos SVG disponibles para la sección "Por qué elegirnos"
// Cada icono es un string con el contenido del path(s) SVG
...
export const iconos: Record<string, string> = {
  ...
  whatsapp: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 2a10 10 0 00-8.69 14.92L2 22l5.31-1.31A10 10 0 1012 2z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 10.5a.5.5 0 01.5-.5h.01a.5.5 0 01.5.5v.01a.5.5 0 01-.5.5h-.01a.5.5 0 01-.5-.5v-.01zM12.5 10.5a.5.5 0 01.5-.5h.01a.5.5 0 01.5.5v.01a.5.5 0 01-.5.5h-.01a.5.5 0 01-.5-.5v-.01zM16 10.5a.5.5 0 01.5-.5h.01a.5.5 0 01.5.5v.01a.5.5 0 01-.5.5h-.01a.5.5 0 01-.5-.5v-.01z"/>',
};

export function getIconoSvg(nombre: string): string {
  return iconos[nombre] || iconos['heart'];
}
